...
export function newAddExpr(left: PropertyValueExpr, operationType: AddExprOperationType, right: PropertyValueExpr): AddExpr {
...
export function newMulExpr(left: PropertyValueExpr, operationType: MulExprOperationType, right: PropertyValueExpr): MulExpr {
